 ...
 * 
 * $NCDId: @(#)auutil.c,v 1.20 1996/01/26 19:11:42 greg Exp $
 */
...
RESTYPE auComponentType, auFlowType;
FlowPtr auClockedFlows, auUnclockedFlows;
...
freeCompiledFlow(CompiledFlowPtr cmp)
{
    ...
    for (i = 0; i < cmp->numOutputs; i++) {
        ...
        if (cmp->freeComponents) {
            if (cmp->outputs[i].flowEl->raw->type ==
...
static ComponentPtr
createPort(AuUint32 format, AuUint32 numTracks, AuUint32 numSamples,
           AuUint32 lowWater, AuUint32 highWater, AuBool discard)
{
    ComponentPtr port;
    AuUint32 dataSize, minibufSize;
...
createMonitor(AuUint32 format, AuUint32 numTracks)
{
    ...
    c->read = c->minibuf + PAD4(minibufSize) * 2;
...
createWaveForm(int form)
{
    ...
    0x0000, 0x0324, 0x0647, 0x096a, 0x0c8b, 0x0fab, 0x12c7, 0x15e1,
                0x18f8, 0x1c0b, 0x1f19, 0x2223, 0x2527, 0x2826, 0x2b1e,
                0x2e10, 0x30fb, 0x33de, 0x36b9, 0x398c, 0x3c56, 0x3f16,
                0x41cd, 0x447a, 0x471c, 0x49b3, 0x4c3f, 0x4ebf, 0x5133,
                0x539a, 0x55f4, 0x5842, 0x5a81, 0x5cb3, 0x5ed6, 0x60eb,
                0x62f1, 0x64e7, 0x66ce, 0x68a5, 0x6a6c, 0x6c23, 0x6dc9,
                0x6f5e, 0x70e1, 0x7254, 0x73b5, 0x7503, 0x7640, 0x776b,
                0x7883, 0x7989, 0x7a7c, 0x7b5c, 0x7c29, 0x7ce2, 0x7d89,
                0x7e1c, 0x7e9c, 0x7f08, 0x7f61, 0x7fa6, 0x7fd7, 0x7ff5,
                0x7fff, 0x7ff5, 0x7fd7, 0x7fa6, 0x7f61, 0x7f08, 0x7e9c,
                0x7e1c, 0x7d89, 0x7ce2, 0x7c29, 0x7b5c, 0x7a7c, 0x7989,
                0x7883, 0x776b, 0x7640, 0x7503, 0x73b5, 0x7254, 0x70e1,
                0x6f5e, 0x6dc9, 0x6c23, 0x6a6c, 0x68a5, 0x66ce, 0x64e7,
                0x62f1, 0x60eb, 0x5ed6, 0x5cb3, 0x5a81, 0x5842, 0x55f4,
                0x539a, 0x5133, 0x4ebf, 0x4c3f, 0x49b3, 0x471c, 0x447a,
                0x41cd, 0x3f16, 0x3c56, 0x398c, 0x36b9, 0x33de, 0x30fb,
                0x2e10, 0x2b1e, 0x2826, 0x2527, 0x2223, 0x1f19, 0x1c0b,
                0x18f8, 0x15e1, 0x12c7, 0x0fab, 0x0c8b, 0x096a, 0x0647,
                0x0324, 0x0000, 0xfcdc, 0xf9b9, 0xf696, 0xf375, 0xf055,
                0xed39, 0xea1f, 0xe708, 0xe3f5, 0xe0e7, 0xdddd, 0xdad9,
                0xd7da, 0xd4e2, 0xd1f0, 0xcf05, 0xcc22, 0xc947, 0xc674,
                0xc3aa, 0xc0ea, 0xbe33, 0xbb86, 0xb8e4, 0xb64d, 0xb3c1,
                0xb141, 0xaecd, 0xac66, 0xaa0c, 0xa7be, 0xa57f, 0xa34d,
                0xa12a, 0x9f15, 0x9d0f, 0x9b19, 0x9932, 0x975b, 0x9594,
                0x93dd, 0x9237, 0x90a2, 0x8f1f, 0x8dac, 0x8c4b, 0x8afd,
                0x89c0, 0x8895, 0x877d, 0x8677, 0x8584, 0x84a4, 0x83d7,
                0x831e, 0x8277, 0x81e4, 0x8164, 0x80f8, 0x809f, 0x805a,
                0x8029, 0x800b, 0x8001, 0x800b, 0x8029, 0x805a, 0x809f,
                0x80f8, 0x8164, 0x81e4, 0x8277, 0x831e, 0x83d7, 0x84a4,
                0x8584, 0x8677, 0x877d, 0x8895, 0x89c0, 0x8afd, 0x8c4b,
                0x8dac, 0x8f1f, 0x90a2, 0x9237, 0x93dd, 0x9594, 0x975b,
                0x9932, 0x9b19, 0x9d0f, 0x9f15, 0xa12a, 0xa34d, 0xa57f,
                0xa7be, 0xaa0c, 0xac66, 0xaecd, 0xb141, 0xb3c1, 0xb64d,
                0xb8e4, 0xbb86, 0xbe33, 0xc0ea, 0xc3aa, 0xc674, 0xc947,
                0xcc22, 0xcf05, 0xd1f0, 0xd4e2, 0xd7da, 0xdad9, 0xdddd,
                0xe0e7, 0xe3f5, 0xe708, 0xea1f, 0xed39, 0xf055, 0xf375,
                0xf696, 0xf9b9, 0xfcdc,};
            ...
            case AuElementTypeImportWaveForm:
                {
                    ...
                    if (!(input->component = createWaveForm(p->wave_form)))
                        AU_ERROR(AuBadAlloc, 0);
    ...
    case AuElementTypeSum:
        {
            ...
            for (i = 0;
                ...
                status = compileInputs(client, elements, output, *inputs++,
                                       multiplyConstant, addConstant,
                                       numTracks, inTracks, firstOutTrack,
                                       recompile, inputCnt);
            break;
        }
    default:
...
{
    AuUint32 i, outputCnt = 0, inputCnt, status;
    auElement *el;
        ...
        case AuElementTypeExportMonitor:
            ...
            if (!recompile) {
                ...
                case AuElementTypeExportDevice:
                    {
                        ...
                        output->flowEl->sampleRate = p->sample_rate;
                ...
                if (el->type == AuElementTypeExportBucket) {
                    /* the minibuf needs to be twice as large for
                       output range checking */
                    if (!(output->flowEl->minibuf = (AuUint8 *)
                          aualloc(output->component->minibufSize * 2)))
                        AU_ERROR(AuBadAlloc, 0);
...
AuProcessFlows(FlowPtr fl)
{
    FlowPtr flow, f;
    CompiledFlowPtr new;
    CompiledFlowOutputPtr output, newOutput;
    int i, j, numGroups, totalInputs;
    AuUint32 maxRate = 0, r;
    ...
    while (flow) {
        ...
        for (i = 0; i < flow->compiled.numOutputs; i++, output++) {
            ...
            new->physicalDeviceMask |=
                    output->component->physicalDeviceMask;
            ...
            while (f) {
                int k;
                CompiledFlowOutputPtr *group, out;
                CompiledFlowPtr cmp;
            ...
            for (j = 0; j < newOutput->numInputs; j++) {
                ...
                new->physicalDeviceMask |=
                        input->component->physicalDeviceMask;
            ...
            r = newOutput->flowEl->raw->type == AuElementTypeExportDevice ?
                    newOutput->flowEl->sampleRate :
                    newOutput->component->sampleRate;
...
{
    int i, state = el->state,   /* so these don't get changed */
...
AuBool
AuChangeElementState(FlowPtr flow, AuUint32 elementNum, AuUint32 newState,
                     AuUint32 processFlow, int reason)
{
    AuBlock l;
    FlowElementPtr el;
    int first, last, i;
            ...
            case AuElementTypeImportClient:
                if (el->component->discard) {
                    el->component->read = el->component->write =
                            el->component->data;
                    el->component->incoming =
                            el->component->currentSize = 0;
                }
    ...
    for (i = first; i <= last; i++) {
        ...
        if (el->stateChange) {
            ...
            if (el->raw->type == AuElementTypeImportClient &&
                ...
                checkForTriggeredActions(el, processFlow,
                                         AuReasonUnderrun);
            } else
...
void
AuProcessStateChanges(AuUint32 numStates, auElementState * states,
                      FlowPtr * flows)
{
    while (numStates--) {
            ...
            if (mask & 1)
                ...
                case AuCompDeviceChildrenMask:
                    ...
                    if (memcmp(c->children, varData,
                               DEVICE(num_children) * sizeof(AuDeviceID)))
                        return AuFalse;

                    varData += DEVICE(num_children) * sizeof(AuDeviceID);
                    break;
                }
